...
#define RETENTION_TIME	20000		// ms ? 20000 ~ 300ms
#define REPEAT_TIME		20000		// ms ? Время, через которое повторять RetainAction
...
/**********************************************************************
  * @brief  Поток управления кнопками. Вызывать в прерывании каждую 1 мс
  * @param  None
  * @retval None
  ********************************************************************/
